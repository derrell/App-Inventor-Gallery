 ...
 */
qx.Class.define("aiagallery.module.dgallery.mystuff.MyStuff",
{
  type : "singleton",
  ...
  members :
  {
    ...
    initialAppear : function(module)
    {
      ...
      aiagallery.module.dgallery.mystuff.Fsm.getInstance().buildFsm(module);

      // Create the real gui.
      aiagallery.module.dgallery.mystuff.Gui.getInstance().buildGui(module);
    }
  }
});
