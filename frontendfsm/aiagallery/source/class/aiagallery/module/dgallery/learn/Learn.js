 ...
 * Gallery "Learn" Page
 */
qx.Class.define("aiagallery.module.dgallery.learn.Learn",
{
  type : "singleton",
  ...
  members :
  {
    ...
    initialAppear : function(module)
    {
      ...
      aiagallery.module.dgallery.learn.Fsm.getInstance().buildFsm(module);

      // Create the real gui.
      aiagallery.module.dgallery.learn.Gui.getInstance().buildGui(module);
    }
  }
});
