 ...
 */
qx.Class.define("aiagallery.module.gallery.findapps.FindApps",
{
  type : "singleton",
  ...
  members :
  {
    ...
    initialAppear : function(module)
    {
      ...
      aiagallery.module.gallery.findapps.Fsm.getInstance().buildFsm(module);

      // Create the real gui.
      aiagallery.module.gallery.findapps.Gui.getInstance().buildGui(module);
    }
  }
});
