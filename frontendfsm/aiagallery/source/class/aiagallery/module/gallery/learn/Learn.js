 ...
 * Gallery "Learn" Page
 */
qx.Class.define("aiagallery.module.gallery.learn.Learn",
{
  type : "singleton",
  ...
  members :
  {
    ...
    initialAppear : function(module)
    {
      ...
      aiagallery.module.gallery.learn.Fsm.getInstance().buildFsm(module);

      // Create the real gui.
      aiagallery.module.gallery.learn.Gui.getInstance().buildGui(module);
    }
  }
});
