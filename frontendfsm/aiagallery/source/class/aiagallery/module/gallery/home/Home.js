 ...
 * Gallery Home Page
 */
qx.Class.define("aiagallery.module.gallery.home.Home",
{
  type : "singleton",
  ...
  members :
  {
    ...
    initialAppear : function(module)
    {
      ...
      aiagallery.module.gallery.home.Fsm.getInstance().buildFsm(module);

      // Create the real gui.
      aiagallery.module.gallery.home.Gui.getInstance().buildGui(module);
    }
  }
});
