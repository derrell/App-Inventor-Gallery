 ...
 * User management
 */
qx.Class.define("aiagallery.module.mgmt.users.Users",
{
  type : "singleton",
  ...
  members :
  {
    ...
    initialAppear : function(module)
    {
      ...
      aiagallery.module.mgmt.users.Fsm.getInstance().buildFsm(module);

      // Create the real gui.
      aiagallery.module.mgmt.users.Gui.getInstance().buildGui(module);
    }
  }
});
