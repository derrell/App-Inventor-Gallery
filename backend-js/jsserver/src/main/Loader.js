...
try
{
  ...
  classname = "qx.type.BaseError";
  new Packages.qx.type.BaseError();

  classname = "qx.core.AssertionError";
  new Packages.qx.core.AssertionError();

  classname = "qx.core.ValidationError";
  ...
  classname = "qx.event.dispatch.Direct";
  new Packages.qx.event.dispatch.Direct();

  classname = "qx.event.handler.Object";
  new Packages.qx.event.handler.Object();

  classname = "qx.lang.Date";
  new Packages.qx.lang.Date();

  classname = "qx.lang.Generics";
  new Packages.qx.lang.Generics();

  classname = "qx.lang.JsonImpl";
  ...
  classname = "aiagallery.dbif.MVisitors";
  ...
  classname = "aiagallery.dbif.ObjComments";
  new Packages.aiagallery.dbif.ObjComments();
  
  classname = "aiagallery.dbif.ObjDownloads";
  new Packages.aiagallery.dbif.ObjDownloads();
  
  classname = "aiagallery.dbif.ObjFlags";
  new Packages.aiagallery.dbif.ObjFlags();
  
  classname = "aiagallery.dbif.ObjLikes";
  new Packages.aiagallery.dbif.ObjLikes();
  
  classname = "aiagallery.dbif.ObjTags";
  ...
  classname = "aiagallery.dbif.ObjSearch";
